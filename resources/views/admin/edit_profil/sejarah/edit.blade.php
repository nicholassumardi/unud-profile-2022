...
<div class="page-heading">
        ...
        <form action="{{route('sejarah.update', $sejarah->id_sejarah)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-end">
                    <a href="{{route('sejarah.index')}}" class="btn btn-outline-success btn-sm"><i
                ...
                <div class="card-body p-5">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <textarea name="content" id="summernote" value="{{$sejarah->content}}"></textarea>
    ...
    @push('js')
    <script>
        $('#summernote').summernote('code', {!! json_encode($sejarah->content) !!});
