...
<div class="page-heading">
    ...
    <div class="container-fluid mt--6">
        <form action="{{route('prestasiAkademik.update', $dataPrestasi->id_prestasi_akademik)}}" method="POST" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-end">
                    <a href="{{route('prestasiAkademik.index')}}" class="btn btn-outline-success btn-sm"><i class="bi bi-arrow-left"></i> Back</a>
                </div>
